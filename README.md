...
technologies used:  Machine Learning,Speech Recognition, Kaldi, Shell Script
    ...
    3 - To run microphoneTeste.py it is necessary to install Vosk, use the command ''pip install vosk'' (or pip3). 
        Don't forget to check Vosk dependencies.

    4 - Run the microphoneTest.py script

    5 - Make sure your microphone is turned on and with the proper sensitivity. 
        Speak some vowel into the microphone and wait for the result.
